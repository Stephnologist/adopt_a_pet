  ...
  public void seed() {
    ...
    for(AdoptablePet seed : seeds) {
      ...
      if (pets.size()==0) {
        ...
        pet.setAge(seed.getAge());
        pet.setVaccinationStatus(seed.getVaccinationStatus());
        pet.setAdoptionStory(seed.getAdoptionStory());
        pet.setAdoptionStatus(seed.getAdoptionStatus());
        pet.setPetType(seed.getPetType());
